...
const TestimonialCarousel = () => {
  ...
  return (
    <div className="w-full py-16 md:px-9 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-16">
          <h3 className="text-xl md:text-2xl font-bold text-gray-800 mb-8">
            Want to give us a shot? Start off on the right foot!
          </h3>
          {isMounted ? (
            <motion.button
              className="bg-violet-600 hover:bg-violet-700 text-white py-3 px-8 rounded-md font-medium"
            ...
            <button className="bg-violet-600 hover:bg-violet-700 text-white py-3 px-8 rounded-md font-medium transition-colors duration-300">
              GET 10% OFF MY FIRST VISIT
            </button>
          )}
        </div>
