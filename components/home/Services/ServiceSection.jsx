...
const ServiceSection = () => {
  ...
  return (
    <section className="py-16 px-4 md:px-9 lg:px-20 bg-white">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <motion.h3
            className="text-xl text-center md:text-2xl font-bold text-gray-800 mb-6 md:mb-0"
            initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
          >
            Are you interested? Send us your email!
          </motion.h3>

          <motion.button
            className="bg-violet-600 hover:bg-violet-700 text-white font-medium py-3 px-6 rounded-lg w-full md:w-auto"
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
